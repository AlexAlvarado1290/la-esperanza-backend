...
// JSON.stringify no sabe serializar BigInt; AuditLog.idLog es BigInt y rompe la
// respuesta de GET /api/audit (RF37). Se convierte a string en cualquier payload.
